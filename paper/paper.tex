...
\textbf{Data:} All benchmarks use synthetic data generated programmatically (smooth gradients, gaussian blobs, satellite-like patterns, MRI-like volumes). This allows controlled experiments with known ground truth. Validation on real-world public datasets (e.g., IXI MRI, UC Merced satellite, DIV2K) is an important direction for future work.
